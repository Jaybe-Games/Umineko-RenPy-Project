...
define rg1 = Character('    Lucifer    ', color="#fff", callback=name_callback, cb_name='rg1')
define rg2 = Character('    Leviathan    ', color="#fff", callback=name_callback, cb_name='rg2')
define rg3 = Character('    Satan    ', color="#fff", callback=name_callback, cb_name='rg3')
define rg4 = Character('    Belphegor    ', color="#fff", callback=name_callback, cb_name='rg4')
define rg5 = Character('    Mammon    ', color="#fff", callback=name_callback, cb_name='rg5')
define rg6 = Character('    Beelzebub    ', color="#fff", callback=name_callback, cb_name='rg6')
define rg7 = Character('    Asmodeus    ', color="#fff", callback=name_callback, cb_name='rg7')
...
define sat = Character('    Satoko    ', color="#fff", callback=name_callback, cb_name='sat')
