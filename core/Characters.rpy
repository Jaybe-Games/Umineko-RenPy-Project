...
define kin = Character('Ushiromiya Kinzo {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='kin', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define cla = Character('Ushiromiya Krauss {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='cla', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define nat = Character('Ushiromiya Natsuhi {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='nat', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define jes = Character('Ushiromiya Jessica {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='jes', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define eva = Character('Ushiromiya Eva {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='eva', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define hid = Character('Ushiromiya Hideyoshi {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='hid', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define geo = Character('Ushiromiya George {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='geo', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define rud = Character('Ushiromiya Rudolf {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='rud', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define kyr = Character('Ushiromiya Kyrie {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='kyr', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define but = Character('Ushiromiya Battler {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='but', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define mar = Character('Ushiromiya Maria {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='mar', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
define ros = Character('Ushiromiya Rosa {image=gui/wing.png}{alt}wing{/alt}', color="#fff", callback=name_callback, cb_name='ros', ctc="ctc_blink", ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.1)
