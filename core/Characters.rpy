...
define but = Character('Ushiromiya Battler {image=gui/wing.png}{alt}wing{/alt}', show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="but", callback=speaker("but"))
define mar = Character('Ushiromiya Maria {image=gui/wing.png}{alt}wing{/alt}', show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="mar", callback=speaker("mar"))
define ros = Character('Ushiromiya Rosa {image=gui/wing.png}{alt}wing{/alt}', ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="ros", callback=speaker("ros"))
define nan = Character('Nanjo Terumasa {image=gui/wing.png}{alt}wing{/alt}', ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="nan", callback=speaker("nan"))
define gen = Character('Ronoue Genji {image=gui/wing.png}{alt}wing{/alt}', ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="gen", callback=speaker("gen"))
define sha = Character('Shannon {image=gui/wing.png}{alt}wing{/alt}', ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="sha", callback=speaker("sha"))
define kan = Character('Kanon {image=gui/wing.png}{alt}wing{/alt}', ctc_position="nestled-close", show_slow_effect = slow_fade, show_slow_effect_delay = 0.2, voice_tag="kan", callback=speaker("kan"))
