...
screen musicupdate():
    ...
    text _("Die Musikbox wurde freigeschaltet!") size 40 xalign 0.95 yalign 0.5 font "fonts/ArnoPro.otf" outlines [ (absolute(3), "#000", absolute(0), absolute(0)) ] at updatemessagetransform

    timer 8 action Hide('musicupdate')
