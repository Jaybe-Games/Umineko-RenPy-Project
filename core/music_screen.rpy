...
define gui.music_room_volume_options_xpos = int(1070 * ost.scale)
define gui.music_room_volume_options_ypos = int(492 * ost.scale)
            ...
            for st in ost.soundtracks:
                textbutton "[st.name]":
                    ...
                    if ost.game_soundtrack:
                        ...
                        SetVariable("ost.pausedstate", False), 
                        Play("music_room", st.path, loop=ost.loopSong, fadein=0.0)]
