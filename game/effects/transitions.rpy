...
define breakupin = ImageDissolve(breakup_mask,1.5,reverse=False, ramplen = 30)
define breakupinslow = ImageDissolve(breakup_mask,3,reverse=False, ramplen = 40)
define breakupinq = ImageDissolve(breakup_mask,0.99,alpha=False, ramplen = 40)
define breakupout = ImageDissolve(breakup_mask,2,alpha=True,reverse=True, ramplen = 40)
define breakupoutq = ImageDissolve(breakup_mask,0.99,alpha=False,reverse=True, ramplen = 40)
