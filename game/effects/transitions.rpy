...
define breakup = Image("images/masks/breakup.png")
define breakupin = ImageDissolve(breakup,1.5,reverse=False, ramplen = 30)
define breakupinslow = ImageDissolve(breakup,3,reverse=False, ramplen = 40)
define breakupinq = ImageDissolve(breakup,0.99,alpha=False, ramplen = 40)
define breakupout = ImageDissolve(breakup,2,alpha=True,reverse=True, ramplen = 40)
define breakupoutq = ImageDissolve(breakup,0.99,alpha=False,reverse=True, ramplen = 40)
