...
define gradientwipedown = ImageDissolve("/images/masks/down.png", 2.0, ramplen = 300)
...
define witchfadeinslow = ImageDissolve(witchfade,3,reverse=False, ramplen = 40)
define witchfadeinq = ImageDissolve(witchfade,0.99,alpha=False, ramplen = 40)
define witchfadeout = ImageDissolve(witchfade,2,alpha=True,reverse=True, ramplen = 40)
define witchfadeoutq = ImageDissolve(witchfade,0.99,alpha=False,reverse=True, ramplen = 40)
