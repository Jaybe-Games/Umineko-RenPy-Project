...
transform chara_shake:
    choice:
        ease 0.041666666666666664 offset (8, 0)
    choice:
        ease 0.041666666666666664 offset (-8, 0)
    choice:
        ease 0.041666666666666664 offset (0, 8)
    choice:
        ease 0.041666666666666664 offset (0, -8)
    choice:
        ease 0.041666666666666664 offset (8, 8)
    choice:
        ease 0.041666666666666664 offset (-8, -8)
    choice:
        ease 0.041666666666666664 offset (-8, 8)
    choice:
        ease 0.041666666666666664 offset (8, -8)
        ease 0.041666666666666664 offset (0,0)
    repeat 4

transform jump_shake:
    ease 0.16666666666666666 offset (0, -10)
    ease 0.16666666666666666 offset (0,0)

transform updown_shake:
    ease 0.25 offset (0, 20)
    ease 0.25 offset (0,0)
    repeat 2

transform leftright_shake:
    ease 0.16666666666666666 offset (-10, 0)
    ease 0.16666666666666666 offset (0,0)
    repeat 2

transform walk:
    ease 0.125 offset (0, 15)
    ease 0.125 offset (0,0)
    repeat 3

transform walk_updown2:
    ease 0.16666666666666666 offset (0, 20)
    ease 0.16666666666666666 offset (0,0)
    repeat 2

transform walk_updown3:
    ease 0.25 offset (0, 15)
    ease 0.25 offset (0,0)
    repeat 2

transform walk_updown1:
...
transform screenshake:
    ...
    choice:
        ease 0.03333333333333333 offset (-12, 0)
    choice:
        ease 0.03333333333333333 offset (0, 12)
    choice:
        ease 0.03333333333333333 offset (0, -12)
    choice:
        ease 0.03333333333333333 offset (12, 12)
    choice:
        ease 0.03333333333333333 offset (-12, -12)
    choice:
        ease 0.03333333333333333 offset (-12, 12)
    choice:
        ease 0.03333333333333333 offset (12, -12)
        ease 0.03333333333333333 offset (0,0)
    repeat 5

transform screenshake_big:
    choice:
        ease 0.05 offset (15, 0)
    choice:
        ease 0.05 offset (-15, 0)
    choice:
        ease 0.05 offset (0, 15)
    choice:
        ease 0.05 offset (0, -15)
    choice:
        ease 0.05 offset (15, 15)
    choice:
        ease 0.05 offset (-15, -15)
    choice:
        ease 0.05 offset (-15, 15)
    choice:
        ease 0.05 offset (15, -15)
        ease 0.05 offset (0,0)
    repeat 7

transform screenshake_long:
    choice:
        ease 0.03333333333333333 offset (12, 0)
    choice:
        ease 0.03333333333333333 offset (-12, 0)
...
transform run:
    ease 0.08333333333333333 offset (0, 15)
    ease 0.08333333333333333 offset (0,0)
    repeat 4

transform jumping:
    ease 0.08333333333333333 offset (0, -10)
    ease 0.08333333333333333 offset (0,0)
    repeat 2