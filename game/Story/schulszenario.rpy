...
label schule:
    ...
    vir "Eure Hoheit..."
    vir "Ich bin wirklich überrascht, Euch so früh hier zu sehen..."
    "\"Virgilius!"
    ...
    extend " sah man einen unheimlichen Mann, der von einer so gewaltigen Aura umgeben ist," 
    extend " dass man den Druck selbst auf einer enormen Entfernung noch zu spüren ist."
    "Vor ihm kniet einer seiner Diener, der es nicht wagte, sein Haupt ohne einen direkten Befehl zu erheben."
    ...
    show screen showch
    "Ein schwerer Taifun ist am vorherigen Tag über die Insel Rokkenjima hereingebrochen."
    extend " Wind, der sich so anfühlt, als würde einem die Luft auspeitschen,"
    extend " Starker Regen, der sich so anfühlt, als würde ein Masseur gleichmäßig aber relativ gewaltsam die Haut weichklopfen."
    ...
    "Der Bedienstete und die Herrin stellten die ganze Villa auf den Kopf, es gab aber keinerlei Spuren von den vermissten."
    "Gerade als beide in die Eingangshalle zurückkehrten, lief ihnen ein bekanntes Gesicht entgegen."
    eva "Natsuhi!"
    extend " ...Genji!"
    ...
    "Zwei weitere Gesichter betraten die Villa," 
    extend " ein leicht übergewichtiger Arzt, der mittlerweile seinen Ruhestand genießt"
    "Und ein sehr ruhiger Bediensteter, der wirkt, als sei er stets fokusiert, aber kein Teil dieser Welt zu sein scheint."
    ...
    "Angekommen am Gartenschuppen, bemerkten die Anwesenden, dass etwas nicht stimmt."
    "Auf dem Tor wurde seltsames Graffiti gesprüht, es sieht so aus wie ein blutroter Kreis mit einem Militärskreuz darauf?"
    ...
    "Genji sprintete zurück in die Villa um den Schlüssel zu holen, in der Zwischenzeit gehen ebenfalls im Gästehaus bei einigen die Augen auf"
    mar "Uu!"
    "Ist es schon morgen?"
    ...
    "Battler ist noch völlig Schlaftrunken, für ihn ergeben die Wörter von Jessica noch überhaupt keinen Sinn."
    ...
    extend " Unsere Hohlbirne muss sich vom aufwachen erholen!"
    but "Jo, Jessica-chan!"
    ...
    mar "Uu~!"
    "Die drei schnapten sich einen Regenschirm und gingen nach draußen in Richtung Gartenschuppen."
    "Fast angekommen bemerkten, sie schnell, dass die Erwachsenen wohl nicht viel davon halten, dass die drei auf sie zukommen."
    "Eva und Natsuhi fuchteln wie Wild mit den Armen rum als Zeichen sich besser nicht zu nähern."
    nat "NICHT NÄHER KOMMEN!!!"
    eva "BATTLER!!! JESSICA!!!"
    extend " NEHMT MARIA UND GEHT ZURÜCK INS GÄSTEHAUS!!!"
    extend " IHR DÜRFT NICHT NÄHER KOMMEN!"
    "Doch es war schon zu spät, der Blick in den Gartenschuppen war unvermeitlich."
    "Der Anblick der sich allen in diesem Moment bot, wird sich wohl für immer in die Köpfe brennen."
    ...
    "Genji und Kanon hechteten beide aus unterschiedlichen Gründen in Richtung Villa."
    "Kurze Zeit später, nach dem beide in die Dunkelheit des Taifuns verschwunden sind, kamen zwei neue Gesichter auf den Tatort zu."
    ...
    "Nach dem erfolglosen Versuch auch nur irgendjemanden die Sicht auf diese Szene zu versperren, sackt Eva plötzlich in sich zusammen."
    ...
    "Natsuhi die weiterhin versucht einen kühlen Kopf zu bewahren, ist ebenfalls deutlich anzumerken, dass der tot ihres Mannes sie nicht kalt lässt."
