...
label schule:
    ...
    ron "Aber natürlich Eure Hoheit, ich habe sehr vielversprechende Fragmente über Fräulein Beatrice zusammentragen können."
    extend " Ihr werdet euch alle Geheimnisse und tükischen Rätsel an einem Ort ansehen können."
    "\"Das hast du sehr gut gemacht, Ronove."
    ...
    ron "Das extra für Euch vorbereitete Fragment, kann jederzeit angesehen werden."
    "\"Sehr gut!"
    ...
    ron "Ich werde die große Featherine-sama umgehend darüber in Kenntnis setzen."
    ron "Ich bin mir sicher, dass jemand der die Null kontrolliert wie Ihr es tut, es schon früh im ersten Durchlauf herausfinden wird."
    extend " ...Pu ku ku ku"
