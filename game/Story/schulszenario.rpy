...
label schule:
    ...
    eva "Ich bekomme das Tor nicht auf, es ist verschlossen, gibt es keinen Schlüssel?"
    gen "Der Schlüssel ist im Dienstzimmer, ich hole ihn sofort."
    "Genji sprintete zurück zur Villa, um den Schlüssel zu holen, in der Zwischenzeit gingen auch im Gästehaus einigen die Augen auf."
    mar "Uu!"
    "Ist es schon morgen?"
    ...
    "Eva klingt beinahe so, als sei sie überzeugt davon, dass der Täter einer der Bediensteten ist."
    extend " Irgendwo ist das auch zu erwarten, schließlich möchte sie wissen, wer ihren SOhn getötet hat, dass kann ihr niemand verübeln."
    ...
    "Des weiteren wurde der Raum erneut abgeschlossen um die Szene des Verbrechens der Polizei zu überlassen."
    ...
    extend " Verdächtig sind aktuell entweder die, die Zugang zum Schlüssel für den Gartenschuppen hatten, die, die unerkannt im Schatten lauern oder die Hexe."
    ...
    "Alle Anwesenden stehen unter Schock, die neun Jährige Maria, die nicht einmal ganze Sätze ohne 'Uu' sagen kann, spricht plötzlich über Magiekreise und Biblische Zitate."
    "Noch viel schlimmer ist, dass sie es mit einem gruseligen Gesichtsausdruck gesagt hat, so selbstsicher, als würde sie etwas wissen, dass andere nicht wissen."
    ...
    mar "Kihihihihihihi!"
    extend " Ich habe ein ganzes Buch voller magischer Kreise und deren Bedeutung."
    "Maria hat durch ihre kindliche Art in der Schule nicht wirklich viele Freunde und sie bekam oft Schelte von ihrer nun verstorbenen Mutter"
    extend " allerdings ist sie großer Fan des okkulten, was diesen Auftritt zumindest etwas erklären könnte."
    jes "Euch fällt auch gerade auf, dass Maria sich seltsam benimmt?"
    extend " ...Da ist doch was im Busch!"
    ...
    "Maria fängt immer an in ein Tohuwabohu zu geraten, wenn jemand in ihrer Gegenwart die Existenz der Hexe leugnet."
