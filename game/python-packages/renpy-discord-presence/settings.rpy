...
define discord.application_id = "" #1245360144146104323

#####################################################################################################################################

# State of the Presence upon the game's launch and return to the main menu..
define discord.main_menu_state = { "details" : "In the Main Menu.", "large_image" : "main", "small_image" : "window_icon"}

# State of the Presence when the game is started.
define discord.start_state = { "details" : "EP1: Legend of the Golden Witch", "state" : "Chapter 1 | by Jaybe Games", "large_image" : "episode1", "small_image" : "window_icon"}
...
define discord.start_label = "umi1_1"
