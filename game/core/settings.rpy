...
define discord.application_id = "1087172026978013254"

#####################################################################################################################################

# State of the Presence upon the game's launch and return to the main menu..
define discord.main_menu_state = { "state" : "In Main Menu",
                                   "small_image" : "zero",
                                   "large_image" : "mainmenu"}

# State of the Presence when the game is started.
define discord.start_state = { "state" : "Prologue: Writing to you in a quadrillion years.",
"details" : "Reading the Story.",
"small_image" : "zero",
"large_image" : "mainmenu"}
