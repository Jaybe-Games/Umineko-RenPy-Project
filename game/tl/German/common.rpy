translate German strings:
    ...
    new "Versucht einen Rollback zu einem früheren Zeitpunkt, damit Sie speichern oder eine andere Wahl treffen können."
    ...
    new "Ignoriert die Fehlermeldung, so dass Sie fortfahren können."

    # renpy/common/_errorhandling.rpym:737
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Ignoriert die Fehlermeldung, so dass Sie fortfahren können. Dies führt häufig zu weiteren Fehlern."
    ...
    new "Lädt das Spiel von der Festplatte neu, speichert und stellt den Spielstatus wieder her, wenn möglich."
    ...
    new "Das Parsing des Skripts ist fehlgeschlagen."

# TODO: Translation updated at 2024-05-28 16:01
